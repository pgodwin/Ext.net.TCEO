...
<head runat="server">
    ...
    <script runat="server">
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            this.Chart1.Series["Default"].Points.DataBind(data, "EmployeeName", "Total", "");
            this.Chart1.Series["Default"]["PieLabelStyle"] = "Outside";    

            // Explode selected employees
            double max = 0;
            DataPoint maxPoint = null;
            
            foreach (DataPoint point in this.Chart1.Series["Default"].Points)
            {
