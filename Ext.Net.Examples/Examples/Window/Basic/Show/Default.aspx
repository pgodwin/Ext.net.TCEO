...
<body>
    <form runat="server">
        ...
        <div class="information">
            <p>In the example below, the Buttons which fire DirectEvents have been set with a 250 millisecond delay (<code>MinDelay="250"</code>) to allow the user time to read the Ajax Load Mask ("Loading...").</p>
        </div>
