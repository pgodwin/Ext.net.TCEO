        ...
        <ext:Panel 
            ...
            <Buttons>
                <ext:Button runat="server" Text="Submit" Icon="Lightning">
                    <Listeners>
                        <Click Handler="Ext.net.DirectMethods.LogCompanyInfo(#{TextField3}.getValue(), #{ComboBox3}.getValue());" />
                    </Listeners>
                </ext:Button>
            </Buttons>
        </ext:Panel>
...
&lt;/ext:Button>
        ...
        <p>When the [DirectMethod] Attribute is added to a server-side Method, by default, a JavaScript function of the same name, and accepting the same
            parameters will be created in the client-side Ext.net.DirectMethods arry.</p>
        
        <p>For example, if we create a server-side Method called "GetTimeStamp", on the client, the Ext.net.DirectMethods.GetTimeStamp JavaScript function will also be created.</p>
