...
<body>
    <form runat="server">
        ...
        <ext:Panel runat="server" Width="600" Height="400" Layout="Fit">
            ...
            <BottomBar>
                 <ext:Toolbar runat="server" EnableOverflow="true">
                    ...
                    <Plugins>
                        <ext:ToolbarDroppable runat="server" Mode="Remote" OnItemCreate="ToolbarItemCreate">
                            <BeforeRemoteCreate Handler="e.options.company = e.data.draggedRecord.get('company');e.options.change = e.data.draggedRecord.get('change');" />
                            <AfterRemoteCreate Handler="alert(e.message);" />
                        </ext:ToolbarDroppable>
        ...
        <ext:DragZone runat="server" Target="DataView1.getEl()">
