...
<body>
    <form runat="server">
        ...
        <ext:Window 
            ...
            Layout="Form">
            <Items>
                <ext:TextField ID="txtFirstName" runat="server" FieldLabel="First Name" AllowBlank="false" AnchorHorizontal="100%" />
                <ext:TextField ID="txtLastName" runat="server" FieldLabel="Last Name" AllowBlank="false" AnchorHorizontal="100%" />
                <ext:TextField ID="txtCompany" runat="server" FieldLabel="Company" AnchorHorizontal="100%" />
