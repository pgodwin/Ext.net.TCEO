...
<body>
    <form runat="server">
        ...
        <ext:Viewport runat="server" Layout="Fit">
            <Items>
                <ext:Panel runat="server" Header="false" Border="false" Padding="15" Layout="Fit">
                    <Items>
                        <ext:Panel 
                            runat="server" 
                            Title="New Email" 
                            ...
                            <Items>
                                <ext:Panel runat="server" BaseCls="x-plain" Border="true" Layout="Absolute">
                                    <Items>
                                        ...
                                        <ext:TextArea runat="server" X="0" Y="91" AnchorHorizontal="100%" AnchorVertical="100%" />
                                    </Items>
                                </ext:Panel>
                            </Items>
                        </ext:Panel>
