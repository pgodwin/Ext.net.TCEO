...
<body>
    ...
    <ext:Store runat="server" ID="Store1">
        ...
        <UpdateProxy>
            <ext:HttpWriteProxy Method="POST" HandleSaveResponseAsXml="true" Url="../../Shared/SuppliersService.asmx/SaveSuppliers" />
        </UpdateProxy>
        <Reader>
            ...
            <ext:BorderLayout ID="BorderLayout1" runat="server">
                <North>
                    <ext:Panel 
                        ...
                        Height="120" 
                        Padding="20"
                        Html="<h1>CRUD Grid Example</h1><p>Demonstrates how to get data from web-service and save using web service.</p>"
                        />
                </North>
                <Center>
                     <ext:GridPanel 
