        ...
        <ext:ToolTip 
            ...
            <Content>
                <div id="content-tip">
                    ...
                    <div class="x-clear"></div>
                    <img src="images/house.jpg" alt="Website Thumbnail" style="margin:1px solid grey;padding:1px;" />
                </div>
            </Content>
            <Listeners>
                <Render Handler="this.header.on('click', function(e){e.stopEvent();Ext.Msg.alert('Link', 'Link to something interesting.');ContentAnchorTip.hide();}, this, {delegate:'a'});" />
            </Listeners>
         </ext:ToolTip>
