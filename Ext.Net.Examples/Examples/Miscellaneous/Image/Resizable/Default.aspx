...
<body>
    <form runat="server">
        ...
        <ext:Viewport runat="server" Layout="border">
            <Items>
                <ext:Panel runat="server" Border="false" Region="North" Height="160" Padding="20">
                    <Content>
                        ...
                        <ext:Toolbar runat="server" Flat="true">
                            <Items>
                                ...
                                <ext:ComboBox 
                                    ...
                                    <SelectedItem Value="0.33" />
                                    <Listeners>
                                        <Select Handler="resize(#{Image1}, record ? record.get('value') : null);" />
                                    </Listeners>
                                </ext:ComboBox>
                ...
                <ext:Panel runat="server" Border="false" AutoScroll="true" Region="Center" Padding="20">
                    <Items>
                        <ext:Image 
                            ID="Image1" 
                            runat="server"
