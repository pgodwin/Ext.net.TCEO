...
namespace Ext.Net
{
    public partial class BaseMenuItemDirectEvents
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        public override ConfigOptionsCollection ConfigOptions
        {
            get
            {
                ...
                list.Add("deactivate", new ConfigOption("deactivate", new SerializationOptions("activate", typeof(DirectEventJsonConverter)), null, this.Deactivate ));
