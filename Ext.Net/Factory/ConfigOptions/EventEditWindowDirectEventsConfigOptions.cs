...
namespace Ext.Net
{
    public partial class EventEditWindowDirectEvents
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        public override ConfigOptionsCollection ConfigOptions
        {
            get
            {
                ...
                list.Add("editDetails", new ConfigOption("editDetails", new SerializationOptions("editdetails", typeof(DirectEventJsonConverter)), null, this.EditDetails ));
