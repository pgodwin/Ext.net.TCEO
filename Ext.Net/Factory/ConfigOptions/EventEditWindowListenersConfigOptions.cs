...
namespace Ext.Net
{
    public partial class EventEditWindowListeners
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        public override ConfigOptionsCollection ConfigOptions
        {
            get
            {
                ...
                list.Add("editDetails", new ConfigOption("editDetails", new SerializationOptions("editdetails", typeof(ListenerJsonConverter)), null, this.EditDetails ));
