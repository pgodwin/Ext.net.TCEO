    ...
    public partial class ScriptTagProxy
    {
        ...
        public override ConfigOptionsCollection ConfigOptions
        {
            get
            {
                ...
                list.Add("callbackParam", new ConfigOption("callbackParam", null, "callback", this.CallbackParam ));
                list.Add("noCache", new ConfigOption("noCache", new SerializationOptions("nocache"), true, this.NoCache ));
