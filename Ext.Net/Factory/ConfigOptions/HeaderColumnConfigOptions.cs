    ...
    public partial class HeaderColumn
    {
        ...
        public override ConfigOptionsCollection ConfigOptions
        {
            get
            {
                ...
                list.Add("autoWidthElement", new ConfigOption("autoWidthElement", new SerializationOptions("autoWidth"), true, this.AutoWidthElement ));
                list.Add("autoWidthCorrection", new ConfigOption("autoWidthCorrection", new SerializationOptions("correction"), 3, this.AutoWidthCorrection ));
