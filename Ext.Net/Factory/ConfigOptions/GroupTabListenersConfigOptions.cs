...
namespace Ext.Net
{
    public partial class GroupTabListeners
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        public override ConfigOptionsCollection ConfigOptions
        {
            get
            {
                ...
                list.Add("changeMainItem", new ConfigOption("changeMainItem", new SerializationOptions("changemainitem", typeof(ListenerJsonConverter)), null, this.ChangeMainItem ));
