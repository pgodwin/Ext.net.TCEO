...
namespace Ext.Net
{
    public partial class ContainerDirectEvents
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        public override ConfigOptionsCollection ConfigOptions
        {
            get
            {
                ...
                list.Add("afterLayout", new ConfigOption("afterLayout", new SerializationOptions("afterlayout", typeof(DirectEventJsonConverter)), null, this.AfterLayout ));
                list.Add("beforeAdd", new ConfigOption("beforeAdd", new SerializationOptions("beforeadd", typeof(DirectEventJsonConverter)), null, this.BeforeAdd ));
