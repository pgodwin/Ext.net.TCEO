...
namespace Ext.Net
{
    public partial class BaseMenuItemListeners
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        public override ConfigOptionsCollection ConfigOptions
        {
            get
            {
                ...
                list.Add("deactivate", new ConfigOption("deactivate", new SerializationOptions("activate", typeof(ListenerJsonConverter)), null, this.Deactivate ));
