...
namespace Ext.Net
{
    ...
    [Meta]
    [Description("")]
    public partial class ListViewColumn: StateManagedItem
    {
		/// <summary>
		/// 
		/// </summary>
        ...
        [DefaultValue(false)]
        [NotifyParentProperty(true)]
        [Description("Specify true to enable sorting on this column (defaults to false).")]
    ...
    /// </summary>
    [Description("")]
    public partial class ListViewColumnCollection : StateManagedCollection<ListViewColumn> { }
}