...
namespace Ext.Net
{
    ...
    [Designer(typeof(DateFieldDesigner))]
    ...
    public partial class DateField : TriggerFieldBase, IDate
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        public virtual string AltFormats
        {
            get
            {
                return (string)this.ViewState["AltFormatsString"] ?? "";
            }
            set
            {
                this.ViewState["AltFormatsString"] = value;
            }
        }
        ...
        public virtual string DisabledDatesText
        {
            get
            {
                return (string)this.ViewState["DisabledDatesText"] ?? "";
            }
            set
            {
                this.ViewState["DisabledDatesText"] = value;
            }
        }
